...
seroutput<-c("BPN12_OT12")
serinput<-c("BPN12_SER12",
            "BPN12_JUR12")
...
## 6) SALVANDO EM .XLS
write.xlsx(GENERICA,"BPN12ger.xls",sheetName="Generica",row.names=F,showNA=F)
#######################
...
# tail(GENERICA)
# tail(verif)
# #write.xlsx(verif,paste0("BPN12gerVERIFICACAO ",Sys.Date(),".xls"),sheetName="Generica",row.names=F,showNA=F)
