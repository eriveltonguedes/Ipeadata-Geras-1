...
## 6) SALVANDO EM .XLS
write.xlsx(GENERICA,"BPNger .xls",sheetName="Generica",row.names=F,showNA=F)
#######################
...
# tail(GENERICA)
# tail(verif)
# #write.xlsx(verif,paste0("BPNgerVERIFICACAO ",Sys.Date(),".xls"),sheetName="Generica",row.names=F,showNA=F)
