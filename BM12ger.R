...
seroutput<-c("BM12_XCCM12",
             "BM12_MCCM12",
             "BM12_SBCCCM12")
serinput<-c("SGS12_NDIASUTEISPAS12",
            "BM12_XCC12",
            "BM12_MCC12",
            "BM12_SBCCC12")
...
GENERICA <- GENERICA[dim(GENERICA)[1],]
## 6) SALVANDO EM .XLS
...
# tail(GENERICA)
# tail(verif)
# #write.xlsx(verif,paste0("BM12gerVERIFICACAO ",Sys.Date(),".xls"),sheetName="Generica",row.names=F,showNA=F)